    ...
    >
      ...
      <div className="w-full h-full flex flex-col gap-5 justify-center items-center">
        <div className="card lg:card-side bg-stone-900 shadow-xl w-3/4">
          <figure>
            <img
              src={require("../assets/Uber-Home-Page.png")}
              alt="Uber Homepage Remake"
            />
          </figure>
        ...
        <div className="card lg:card-side bg-stone-900 shadow-xl w-3/4">
          <figure>
            <img
              src={require("../assets/E-Commerce-Site.png")}
              alt="Shopping Cart Site"
            />
          </figure>
          <div className="card-body lg:w-2/4">
        ...
        <div className="card lg:card-side bg-stone-900 shadow-xl w-3/4">
          <figure>
            <img src={require("../assets/Weather-App.png")} alt="Weather App" />
          </figure>
          <div className="card-body lg:w-2/4">
